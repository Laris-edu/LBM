...
| `phase3_m3_grad_10k_dx2p6.yaml` | P3-5+ 全周期 Level C M3 验证配置（`thermal_grad` + `q_feedback_relax`）；含恢复壁温最大误差 `<0.01 K` 门。scoped 10kHz 历史 canonical 为相位 PASS、幅值边界；2026-07-11 仅收紧验证语义，未改变 dx/tau/物理参数。 |
