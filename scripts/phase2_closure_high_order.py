...
Usage:
    python -m scripts.phase2_closure_high_order
"""
...
def _write_report(summary: dict, report_path: Path) -> None:
    lines = [
        ...
        "",
        "本文档由 `python -m scripts.phase2_closure_high_order` 生成。它只诊断 D2Q21 的 `central_moment_closure=fourth_order` 路径，不修改 D2Q21 production baseline，也不声明 final M2 production pass。",
        "",
        "## 结论",
        "",
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--report-out", default="docs/Phase_2/robustness/Phase2_High_Order_Closure_Report.md")
    ...
    summary = {
        ...
        "run_id": timestamp,
        "timestamp": timestamp,
        "command": [sys.executable, "-m", "scripts.phase2_closure_high_order", *sys.argv[1:]],
