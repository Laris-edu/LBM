...
Usage:
    python -m scripts.phase2_robust_high_mode_sensitivity
"""
...
def _write_report(summary: dict, report_path: Path) -> None:
    ...
    lines = [
        ...
        "",
        "本文档由 `python -m scripts.phase2_robust_high_mode_sensitivity` 生成。它只诊断当前 D2Q21 physical-timestep collision 的经验标量，不修改 production baseline，不声明 final M2 production pass。",
        "",
        "## 结论",
        "",
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--report-out", default="docs/Phase_2/robustness/Phase2_High_Mode_Sensitivity_Report.md")
    ...
    summary = {
        ...
        "run_id": timestamp,
        "timestamp": timestamp,
        "command": [sys.executable, "-m", "scripts.phase2_robust_high_mode_sensitivity", *sys.argv[1:]],
