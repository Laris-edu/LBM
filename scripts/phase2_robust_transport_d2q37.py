...
Usage:
    python -m scripts.phase2_robust_transport_d2q37
"""
...
def _write_report(summary: dict[str, Any], report_path: Path) -> None:
    ...
    lines = [
        ...
        "",
        "本文档由 `python -m scripts.phase2_robust_transport_d2q37` 生成。它只覆盖 D2Q37 fallback 新标定口径下的长窗口、mode=2 高模态、高背景速度和 P2-7 Pr 长窗口复核。",
        "",
        "## 结论",
        "",
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--report-out", default="docs/Phase_2/robustness/Phase2_D2Q37_Robustness_Report.md")
    ...
    summary = {
        ...
        "run_id": timestamp,
        "timestamp": timestamp,
        "command": [sys.executable, "-m", "scripts.phase2_robust_transport_d2q37", *sys.argv[1:]],
