...
Usage:
    python -m scripts.phase2_robust_d2q37_failure
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--report-out", default="docs/Phase_2/robustness/Phase2_D2Q37_Failure_Diagnosis_Report.md")
    ...
    summary = {
        ...
        "run_id": timestamp,
        "timestamp": timestamp,
        "command": [sys.executable, "-m", "scripts.phase2_robust_d2q37_failure", *sys.argv[1:]],
