...
Usage:
    python -m scripts.diagnose_phase2_high_mode_acoustic_rr
"""
...
from scripts.diagnose_phase2_acoustic_attenuation_anisotropy import _acoustic_fwd_ratio
from scripts.diagnose_phase2_acoustic_attenuation_caliber import (
    NORMAL_FACTOR,
    XY_FACTOR,
    _clear_symbol_caches,
    _recalibrate_chi,
)
from scripts.diagnose_phase2_recursive_regularized_closure import _rr_config
