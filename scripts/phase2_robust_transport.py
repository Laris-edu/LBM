...
Usage:
    python -m scripts.phase2_robust_transport
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--report-out", default="docs/Phase_2/robustness/Phase2_Transport_Robustness_Report.md")
    ...
    summary = {
        ...
        "run_id": timestamp,
        "timestamp": timestamp,
        "command": [sys.executable, "-m", "scripts.phase2_robust_transport", *sys.argv[1:]],
