...
| WP3 决策材料与 runner | `docs/Phase_5/wp3_go_nogo_decision.md` + `scripts/phase5_a1_signed_zero_mean.py` + `scripts/phase5_a2a_operating_point.py` | **八单元全部完成（D5-5，2026-08-02;双机分跑 D5-3）**：A1 B 机 `20260802T105444Z`、P-DC2 A 机 `20260802T104619Z`(摘要归档 `M5_runs/wp3_*`);§14.1 对照终版=材料支持 `SCOPED_GO`;**正式决策待用户** |
