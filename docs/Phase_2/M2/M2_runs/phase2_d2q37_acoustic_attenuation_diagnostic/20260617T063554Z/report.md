...
|---|---:|
| P2-5 | `PASSED` |
| alpha_relative_error | `0.0193311` |
| heat_flux_relative_error | `0.000750276` |
| P2-6 | `PASSED` |
| attenuation_ratio | `0.881183` |
| attenuation_relative_error | `0.118817` |
| P2-7 | `PASSED` |
| max_pr_relative_error | `0.0178784` |
| P2-9 | `PASSED` |
| P2-9 sound_speed_error | `0.00374738` |
| P2-9 direction_difference | `0.00847291` |
| P2-9 dispersion_masking | `PASSED` |
