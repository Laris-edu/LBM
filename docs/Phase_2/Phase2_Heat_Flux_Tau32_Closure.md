...
本文固化当前 heat-flux collision 与 `tau32` 的理论口径，并分别复核 D2Q21/D2Q37 的 heat-flux scale、Galilean correction 和 D2Q37 high-mode spectral correction。本文只收敛 Phase_2 当前实现边界，不声明 final M2 production pass，不启动 Phase_3 Level C。
