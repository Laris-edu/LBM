...
- `WP4_jacobian_LBM_A2A3/` — WP4-JAB2 第二轮权威 run `20260810T144425Z` 摘要(用户指定路径,
  2026-08-10;六文件精选摘要 + 纯数据 CSV 三件[sigma_table/dop_confirm_pair_trend/verification_metrics,无判读列];
  结果=报告 §7)。
